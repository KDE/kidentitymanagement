...
class Subject : public Base {
  ...
  public:
    Subject() : Base()  {}
    Subject(Content *p) : Base(p)  {}
    Subject(Content *p, const QCString &s) : Base(p)  { from7BitString(s); }
    Subject(Content *p, const QString &s, const QCString &cs) : Base(p)  { fromUnicodeString(s, cs); }
    ~Subject()  {}
...
class Organization : public Base {
  ...
  public:
    Organization() : Base()  {}
    Organization(Content *p) : Base(p)  {}
    Organization(Content *p, const QCString &s) : Base(p)  { from7BitString(s); }
    Organization(Content *p, const QString &s, const QCString &cs) : Base(p)  { fromUnicodeString(s, cs); }
    ~Organization()  {}
...
class CDescription : public Base {
  ...
  public:
    CDescription() : Base()  {}
    CDescription(Content *p) : Base(p)  {}
    CDescription(Content *p, const QCString &s) : Base(p) { from7BitString(s); }
    CDescription(Content *p, const QString &s, const QCString &cs) : Base(p)  { fromUnicodeString(s, cs); }
    ~CDescription()  {}
