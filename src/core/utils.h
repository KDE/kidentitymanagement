 ...
 */
Q_REQUIRED_RESULT KIDENTITYMANAGEMENTCORE_EXPORT bool thatIsMe(const QString &email);
 ...
 */
Q_REQUIRED_RESULT KIDENTITYMANAGEMENTCORE_EXPORT const QSet<QString> &allEmails();
}
