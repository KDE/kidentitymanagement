...
KIdentityManagement::Identity IdentityEditorBackend::identity() const
{
    return m_identity;
}

void IdentityEditorBackend::setIdentity(const KIdentityManagement::Identity &identity)
{
...
void IdentityEditorBackend::saveIdentity(const KIdentityManagement::Identity &modifiedIdentity)
{
